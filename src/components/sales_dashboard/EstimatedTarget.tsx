...
export default function EstimatedTarget() {
  const series = [75.55];
    ...
    <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/[0.03]">
      <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
        <div className="flex justify-between">
          <div>
            <h3 className="text-lg font-semibold text-gray-800 dark:text-white/90">Estimated Target</h3>
        ...
        <div className="relative ">
          <div className="max-h-[330px]" id="chartSalesRadial">
        ...
        <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
          You are close to this month’s target. Keep up your good work!
        </p>
      </div>
